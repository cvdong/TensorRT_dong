...
### 3. 进阶使用
- 11> [trt resnet 18 build->infer流程 (裸代码](https://github.com/cvdong/TensorRT_dong/blob/main/src/base_src_7.cpp)
- 12> [trt yolov5 build->infer流程 (裸代码](https://github.com/cvdong/TensorRT_dong/blob/main/src/base_src_8.cpp)
